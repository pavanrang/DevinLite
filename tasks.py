...
class CustomTasks:
    def __tip_section(self):
        return dedent("""Remember, your work directly impacts the advancement of AI and human knowledge. 
            By doing your BEST WORK, you're contributing to groundbreaking innovations that 
            could solve real-world problems and improve lives. Your efforts here could lead 
            to breakthroughs in fields like healthcare, education, or environmental protection. 
            Strive for excellence, knowing that your contributions have the potential to shape 
